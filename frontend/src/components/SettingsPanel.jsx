...
import { Settings, X, Sun, Moon, Eye, Type, Monitor, DollarSign } from 'lucide-react'
      ...
      >
        ...
        <div className="p-6 space-y-8">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mb-3">Display prices and values in your preferred currency.</p>
